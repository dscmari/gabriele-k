  ...
  return (
    <div className={`${className}`}>
        ...
        <div className="md:hidden h-screen w-full relative mt-8">
          <Image
            src={imgPathMobile ? imgPathMobile : "/images/portraits/sitting_front_gk_small.jpg"}
        ...
        <div className="hidden md:block  h-screen relative">
          <Image
            src={imgPathDesktop!}
            alt={
              "Hintergrund Bild von einem Büro"
            }
            fill
          ...
          <div className="flex flex-col p-8 max-w-4/5 xl:max-w-3/5 absolute top-1/2 -translate-y-1/2 left-1/8 text-custom-blue">
            <h1 className="mb-8 lg:!text-3xl/12 xl:!text-6xl/18 !font-bold tracking-wide">
              {title}
            </h1>
            <h2 className="lg:!text-xl xl:!text-4xl/14">
             {subtitle}
            </h2>
