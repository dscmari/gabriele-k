  ...
  return (
    <div className="m-8 lg:m-16 xl:m-32 privacy">
      ...
      <div>
        ...
        <p>Vercel Inc.</p>
        <p>
          Wir hosten unsere Website bei der Vercel Inc. (440 N Barranca Ave
          #4133, Covina, CA 91723, USA). Wenn Sie unsere Website besuchen,
          werden personenbezogene Daten (z. B. IP-Adresse, Datum/Uhrzeit des
          Zugriffs, Browsertyp) auf den Servern von Vercel verarbeitet, um die
          Anzeige der Website zu ermöglichen. Vercel ist Empfänger Ihrer Daten
          und als Auftragsverarbeiter für uns tätig. Die Datenübertragung in die
          USA erfolgt auf Grundlage von Standardvertragsklauseln der
          EU-Kommission. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die
        ...
        <p>
          Zur Verwaltung und Bereitstellung unserer Website-Inhalte
          (Blogartikel, Texte, Bilder) nutzen wir das Content-Management-System
          (CMS) der Sanity.io AS (Thorvald Meyers gate 9, 0555 Oslo, Norwegen).
          Beim Abruf dieser Inhalte können Metadaten und IP-Adressen an Sanity
          übertragen werden, um die Inhalte korrekt an Ihren Browser
          auszuliefern. Da Sanity seinen Sitz in Norwegen (EWR) hat, erfolgt die
          Verarbeitung auf Basis des europäischen Datenschutzniveaus.
        </p>
      </div>
      <div>
