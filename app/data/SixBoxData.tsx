...
export const stress = [
  {
    icon: <Wind className="shrink-0 text-custom-blue dark:text-darkmode-white" size={48} />,
    title: "Innere Unruhe",
  ...
  {
    icon: <MoonStar className="shrink-0 text-custom-blue dark:text-darkmode-white" size={48} />,
  ...
  {
    icon: <Flame className="shrink-0 text-custom-blue dark:text-darkmode-white" size={48} />,
    title: "Gereiztheit",
  ...
  {
    icon: <Focus className="shrink-0 text-custom-blue dark:text-darkmode-white" size={48} />,
  ...
  {
    icon: <Bot className="shrink-0 text-custom-blue dark:text-darkmode-white" size={48} />,
    title: "Autopilot",
