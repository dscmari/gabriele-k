...
export const smoke = {
  ...
  bullets: [
    {
      icon: <CigaretteOff className="shrink-0" size={36} />,
    ...
    {
      icon: <ShieldCheck className="shrink-0" size={36} />,
    ...
    {
      icon: <BadgeEuro className="shrink-0" size={36} />,
      header: "Geld sparen",
    ...
    {
      icon: <SearchCheck className="shrink-0" size={36} />,
      header: "Vorbild sein",
...
export const methodsFeatures = {
  ...
  bullets: [
    ...
    },
    {
      ...
      text: "Atemübungen sind eine der wirkungsvollsten Methoden, um das Nervensystem zu beruhigen. Durch bewusstes, kontrolliertes Atmen lässt sich Stress binnen Minuten spürbar reduzieren.",
    },
  ],
};
...
export const stressFeatures = {
  ...
  bullets: [
    {
      icon: <Swords className="shrink-0" size={36} />,
    ...
    {
      icon: <HeartCrack className="shrink-0" size={36} />,
      header: "Stressfolgen",
    ...
    {
      icon: <Focus className="shrink-0" size={36} />,
    ...
    {
      icon: <Check className="shrink-0" size={36} />,
      header: "Mein Ansatz",
